 ...
 */
testRouter.get("/template", template_controllers_1.TemplateController.readTest);
/**
 * @swagger
 * /template:
 *   post:
 ...
 *                   error: system generated error message
 */
testRouter.post("/template", template_controllers_1.TemplateController.addNewTest);
/**
 * @swagger
 * /template/:id:
 *   patch:
 ...
 *                   error: system generated error message
 */
testRouter.patch("/template/:id", template_controllers_1.TemplateController.modifyTest);
/**
 * @swagger
 * /template/:id:
 *   delete:
 ...
 *
 */
testRouter.delete("/template/:id", template_controllers_1.TemplateController.removeTest);

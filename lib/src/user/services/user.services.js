...
UserService.addUserToDatabase = (data) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        console.log(error);
        return format_repsonse_1.CustomResponse.sendErrorResponse(messages_1.CustomMessage.MESSAGES.FAILED_TO_CREATE_USER, error);
    }
});
UserService.removeUserFromDatabase = (data) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        return format_repsonse_1.CustomResponse.sendErrorResponse(messages_1.CustomMessage.MESSAGES.FAILED_TO_DELETE_USER, error);
    }
});
UserService.updateUserFromDatabase = (data) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        return format_repsonse_1.CustomResponse.sendErrorResponse(messages_1.CustomMessage.MESSAGES.FAILED_TO_UPDATE_USER, error);
    }
});
UserService.checkUserExists = (data) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        return format_repsonse_1.CustomResponse.sendErrorResponse(messages_1.CustomMessage.MESSAGES.FAILED_LOGIN, error);
    }
});

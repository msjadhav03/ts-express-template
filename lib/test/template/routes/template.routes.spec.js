...
describe("testRouter", () => {
    test("should call TemplateController.readTest when GET /template route is hit", () => __awaiter(void 0, void 0, void 0, function* () {
        const mockRequestHandler = jest.fn();
        yield template_routes_1.default.get(`${constants_1.CustomConstant.TEMPLATE_BASE_URL}`, mockRequestHandler);
    }));
});
